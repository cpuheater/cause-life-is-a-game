...
class Agent(nn.Module):
    def __init__(self, envs, frames=3, rnn_input_size=512, rnn_hidden_size=512):
        ...
        self.lstm = nn.LSTM(rnn_input_size, rnn_hidden_size)
...
rnn_hidden_states = torch.zeros((args.num_steps, 2, args.num_envs, rnn_hidden_size)).to(device)
...
rnn_hidden_state = torch.zeros((2, args.num_envs, rnn_hidden_size))
