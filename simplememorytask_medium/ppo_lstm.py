...
def recurrent_generator(episode_done_indices, obs, actions, logprobs, values, advantages, returns, rnn_hidden_states, cell_hidden_states):
    ...
    num_sequences_per_batch = [ num_sequences_per_batch] * args.num_minibatches  # Arrange a list that determines the episode count for each mini batch
...
if __name__ == "__main__":
    ...
    envs = gymnasium.vector.AsyncVectorEnv([make_env(seed=args.seed+i) for i in range(args.num_envs)],)
