...
DEFAULT_CONFIG = os.path.join(os.getcwd(), "scenarios/deadly_corridor.cfg")
...
if __name__ == "__main__":
    ...
    def color_labels(labels):
        ...
        tmp[labels == 6] = [153, 76, 0]
        tmp[labels == 7] = [255, 178, 102]
        tmp[labels == 8] = [0, 102, 51]
        tmp[labels == 9] = [255, 255, 0]
        tmp[labels == 10] = [255, 255, 0]
        tmp[labels == 11] = [0, 51, 51]
